...
export const statusOptions = [
  ...
  },
  {
    ...
    icon: Check,
    color:
      "bg-green-50 border-green-200 hover:bg-green-100 dark:bg-green-950/50 dark:border-green-800 dark:hover:bg-green-900/50",
  ...
  },
  {
    ...
    icon: XCircle,
    color: "bg-red-50 border-red-200 hover:bg-red-100 dark:bg-red-950/50 dark:border-red-800 dark:hover:bg-red-900/50",
...
export const reasonOptions = [
  {
    ...
    icon: TrendingUp,
    color:
      "bg-emerald-50 border-emerald-200 hover:bg-emerald-100 dark:bg-emerald-950/50 dark:border-emerald-800 dark:hover:bg-emerald-900/50",
