...
import { BarChart3, Building2, Home, Loader2, Search, TrendingUp, X } from "lucide-react";
    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center gap-3">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Error al cargar proyectos</h3>
          <p className="text-gray-500">Ha ocurrido un error al cargar los proyectos. Inténtalo de nuevo.</p>
        </div>
      </div>
    );
  }
                ...
                <div className="mt-2 text-sm text-muted-foreground">
                  {projects.length > 0 ? (
                    <span>
                      ...
                      {projects.length !== 1 ? "s" : ""} para &quot;{search}&quot;
                    </span>
                  ) : (
