...
export default function PaymentSchedulePageClient({ reservationId }: PaymentSchedulePageClientProps) {
  ...
  if (isLoading) {
    return (
      <div>
        <HeaderPage title="Cronograma de Pagos" description="Cargando información de la reserva..." />
  ...
  if (isError) {
    return (
      <div>
        <HeaderPage title="Cronograma de Pagos" description="Error al cargar la información de la reserva" />
        <ErrorGeneral />
      </div>
    );
  }
  ...
  if (!reservation) {
    return (
      <div>
        <HeaderPage title="Cronograma de Pagos" description="Reserva no encontrada" />
