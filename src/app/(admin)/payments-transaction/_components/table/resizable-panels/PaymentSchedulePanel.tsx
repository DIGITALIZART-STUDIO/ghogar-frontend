...
export function PaymentSchedulePanel({ payments, currency }: PaymentSchedulePanelProps) {
  ...
  const pendingCount = payments.filter(
    (p) => (p.amountPaid ?? 0) === 0 && p.dueDate && new Date(p.dueDate) >= new Date()
  ).length;
          ...
          <div className="bg-white dark:bg-gray-950 p-2 sm:p-3 lg:p-4 rounded-lg sm:rounded-xl border border-green-100 dark:border-green-900 min-w-0">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-green-700">
                  {fullyPaidCount}
                </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2 p-2 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="h-3 w-3 sm:h-4 sm:w-4 text-gray-600 dark:text-gray-300">{currencySymbol}</div>
