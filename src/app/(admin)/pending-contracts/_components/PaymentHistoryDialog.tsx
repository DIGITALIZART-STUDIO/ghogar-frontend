...
import { Building2, FileText, DollarSign, Info, CheckCircle, Clock } from "lucide-react";
...
export function PaymentHistoryDialog({
    ...
    const onSubmit = useCallback(async (data: PaymentHistoryFormData) => {
        ...
        const promise = isEditing && payment?.id
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="space-y-2">
                                <FormLabel>
                                    Monto del Pago {reservationData?.remainingAmount ? `(Máx: ${formatAmount(reservationData.remainingAmount)})` : ""}
                                </FormLabel>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-1 gap-3">
                                                        ...
                                                        <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                                            ...
                                                            <Badge variant="outline" className="bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400 font-mono">
                                                        ...
                                                        <div className="flex items-center justify-between p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border-2 border-orange-200 dark:border-orange-800">
                                                            ...
                                                            <Badge variant="outline" className="bg-orange-50 border-orange-300 text-orange-700 dark:bg-orange-900/20 dark:border-orange-700 dark:text-orange-400 font-mono font-semibold">
