  ...
  const toggleAllTransactions = () => {
    if (expandedTransactions.size === transactions.length) {
      ...
      setExpandedTransactions(
        new Set(transactions.map((t) => t.id).filter((id): id is string => typeof id === "string"))
      );
    }
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-xs lg:text-sm text-gray-500 dark:text-gray-400 mt-0.5 hidden lg:block truncate">
                Historial de pagos
              </p>
            </div>
          </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-3 sm:mb-4">
                      <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs lg:text-sm text-gray-600 dark:text-gray-400 font-medium truncate">
                            {methodConfig.label}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="p-3 sm:p-4 lg:p-5 transition-all duration-200">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <h5 className="text-xs lg:text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">
                            Cuotas cubiertas
                          </h5>
                        </div>
