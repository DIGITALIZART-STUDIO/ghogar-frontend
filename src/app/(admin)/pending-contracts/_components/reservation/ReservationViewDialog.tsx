      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[900px] px-0">
          <DialogHeader className="px-4 flex flex-row items-center">
            ...
            <div>
              <DialogTitle className="flex items-center font-montserrat">Detalles de Reserva</DialogTitle>
          ...
          <ScrollArea className="h-full max-h-[70vh] px-0">
            <div className="px-6">
              <ReservationViewContent data={data} isLoading={isLoading} daysLeft={daysLeft} />
            </div>
          </ScrollArea>
        </DialogContent>
      </Dialog>
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="h-[80vh]">
        <DrawerHeader className="border-b border-border flex flex-row items-center">
          <FileText className="h-5 w-5 mr-2" />
          <div>
            <DrawerTitle className="flex items-center font-montserrat">Detalles de Reserva</DrawerTitle>
