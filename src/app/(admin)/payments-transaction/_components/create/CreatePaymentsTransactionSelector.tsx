...
export default function CreatePaymentsTransactionSelector({ availablePayments, selectedPayments, setSelectedPayments, isLoading, error, totalSelectedAmount, totalAvailableAmount, form }: CreatePaymentsTransactionFormProps) {
    ...
    return (
        <div>
            <Card className="border overflow-hidden pt-0 bg-white dark:bg-gray-900">
                <CardHeader className="pb-4 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 pt-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Badge className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-700">
                                {availablePayments.length} disponibles
                            </Badge>
                ...
                <CardContent className="px-1">
                    ...
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center h-96 bg-green-50/30 dark:bg-green-900/30">
                            ...
                            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Cargando cuotas</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Obteniendo cuotas disponibles para la reserva...</p>
                        </div>
                    ) : error ? (
                        <div className="flex flex-col items-center justify-center h-96 bg-red-50/30 dark:bg-red-900/30">
                            <div className="p-4 bg-white dark:bg-gray-950 rounded-full mb-4">
                                <AlertCircle className="text-red-600 dark:text-red-400 w-8 h-8" />
                            </div>
                            <h3 className="font-medium text-red-900 dark:text-red-400 mb-1">Error al cargar cuotas</h3>
                            <p className="text-sm text-red-600 dark:text-red-400 text-center max-w-sm">
                                No se pudo cargar las cuotas. Intenta nuevamente o verifica la reserva seleccionada.
                            </p>
                        </div>
                    ) : (
                                            ...
                                            className={`relative p-4 rounded-2xl border-2 cursor-pointer overflow-hidden ${
                                                isSelected
                                                    ...
                                                    : isOverdue
                                                        ...
                                                        : "border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 hover:border-slate-300 dark:hover:border-gray-600 hover:bg-slate-50 dark:hover:bg-gray-800"
                                            }`}
                                        >
                                            {/* Checkbox flotante */}
                                                ...
                                                <div
                                                    className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${
                                                        isSelected
                                                            ...
                                                            : "border-slate-300 dark:border-gray-700 bg-white dark:bg-gray-900 hover:border-slate-400 dark:hover:border-gray-500"
                                                    }`}
                                                >
                                            ...
                                            <div className="pr-10">
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        <div
                                                            className={`w-8 h-8 rounded-xl flex items-center justify-center transition-all duration-200 ${
                                                                isSelected ? "bg-emerald-100 dark:bg-emerald-900/60" : isOverdue ? "bg-red-100 dark:bg-red-900/60" : "bg-slate-100 dark:bg-gray-800"
                                                            }`}
                                                        >
                                                            <User
                                                                className={`h-4 w-4 ${
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    {/* Monto */}
                                                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 border border-slate-100 dark:border-gray-700">
                                                        ...
                                                        <Badge
                                                            variant="outline"
                                                            className="text-xs mt-1 bg-slate-50 dark:bg-gray-800 text-slate-600 dark:text-gray-400 border-slate-200 dark:border-gray-700"
                                                        >
                                                            {payment.currency}
                                                        </Badge>
                                                    </div>
                    ...
                    {/* Resumen inferior */}
                    {selectedPayments.length > 0 && (
                        <div className="mt-6 pt-6 border-t border-slate-200 dark:border-gray-700 px-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-gray-400">
                                        {selectedPayments.length} cuotas seleccionadas • Total: $
                                        {totalSelectedAmount.toLocaleString()}
                                    </p>
                                </div>
                            </div>
