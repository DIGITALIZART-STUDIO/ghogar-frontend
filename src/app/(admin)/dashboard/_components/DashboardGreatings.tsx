      ...
      <div className="flex items-center gap-3">
        ...
        <div className="space-y-1 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            {isTransitioning && <Sparkles className="h-5 w-5 text-amber-500 animate-pulse" />}
          </div>

          {/* Información del rol y sesión */}
          <div className="flex items-center gap-1">
            <span className="text-sm text-muted-foreground font-medium">Bienvenido de nuevo</span>
            <span className={`text-sm font-medium ${roleInfo.className}`}>{roleInfo.label}</span>
            <span className="text-sm text-muted-foreground font-medium">al Panel Administrativo</span>
          </div>
        </div>
      </div>
    </div>
