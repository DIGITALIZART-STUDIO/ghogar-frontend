...
import { useDashboardSupervisor } from "@/app/(admin)/dashboard/_hooks/useDashboard";
...
export default function SupervisorDashboard() {
    ...
    const { data, isLoading, isError } = useDashboardSupervisor(selectedYear);
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                        {(((data.leadsKpi?.completedLeads ?? 0) / (data.leadsKpi?.totalLeads ?? 1)) * 100).toFixed(1)}%
                                        del total
                                    </p>
                                </div>
