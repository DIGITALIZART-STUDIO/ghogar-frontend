...
import { AlertTriangle, Calendar, CheckCircle2, DollarSign, Hash, Zap } from "lucide-react";
...
export default function CreatePaymentsTransactionHeader({
  form,
  totalSelectedAmount,
  selectedPayments,
  progressPercentage,
    ...
    <Card className="border overflow-hidden pt-0">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-gray-900 border-b pb-2 dark:text-gray-100 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel required>Fecha y Hora del Pago</FormLabel>
                  <FormControl>
                    <DatePicker
                      value={
                        field.value
                          ...
                          <div className="flex items-center gap-2">
                            <span>
                              {(() => {
                                ...
                                const iconClass =
                                  PaymentMethodLabels[field.value as keyof typeof PaymentMethodLabels].iconClass;
                  ...
                  <FormControl>
                    <div className="relative">
                      <Input
                        ...
                        className="pl-4 pr-4 font-mono text-sm"
                        {...field}
                ...
                {form.watch("amountPaid") > totalSelectedAmount ? (
                  <div className="flex items-center gap-2 text-amber-600 bg-amber-50 border border-amber-200 rounded-lg p-3">
                    ...
                    <span className="text-sm font-medium">
                      Se está pagando ${(form.watch("amountPaid") - totalSelectedAmount).toLocaleString()} más de las
                  ...
                  <div className="flex items-center gap-2 text-blue-600 bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <AlertTriangle className="h-4 w-4" />
                    <span className="text-sm font-medium">
                      Se está pagando ${(totalSelectedAmount - form.watch("amountPaid")).toLocaleString()} menos de las
                      cuotas seleccionadas
                    </span>
                  </div>
                ) : (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      <Hash className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-slate-400 dark:text-slate-500" />
                      <Input placeholder="Ingrese el número de referencia" className="pl-10 font-mono" {...field} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
