...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // Función para interceptar errores 401/403 y intentar refresh
  // Solo procesa errores de autenticación, ignora todos los demás (400, 500, etc.)
  const handleAuthError = useCallback(
    async (error: unknown) => {
      ...
      // Solo procesar errores de autenticación (401/403)
      // Todos los demás errores (400 BadRequest, 500 InternalServerError, etc.) se ignoran
      // y deben ser manejados en el componente que los recibe
      if (statusCode === 401 || statusCode === 403 || errorMessage === "Unauthorized") {
      ...
      // Para todos los demás errores, retornar false sin procesar
      // Esto permite que los componentes manejen sus propios errores (400, 500, etc.)
      return false;
    },
