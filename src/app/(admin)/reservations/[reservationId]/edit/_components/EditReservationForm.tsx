            ...
            <div className="bg-card rounded-lg border border-slate-200 dark:border-slate-700">
              ...
              <div className="p-4">
                {quotationData ? (
                  ...
                  <div className="text-sm text-slate-500 dark:text-slate-500">Cotización no encontrada.</div>
                )}
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden lg:sticky lg:top-4">
              ...
              <div className="p-4">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="text-xs text-slate-500 dark:text-slate-500 mb-2">Información de la separación</div>
                ...
                <div className="mt-6 space-y-3">
                  <Button type="submit" disabled={isPending || quotationData.status !== "ACCEPTED"} className="w-full">
                ...
                {quotationData.status !== "ACCEPTED" && (
                  <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>Nota:</strong> Solo se pueden editar reservas de cotizaciones con estado
                      &quot;ACEPTADA&quot;.
                    </p>
                  </div>
                )}
