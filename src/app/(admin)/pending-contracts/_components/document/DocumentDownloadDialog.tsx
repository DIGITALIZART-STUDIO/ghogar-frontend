  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1000px] w-[90vw] px-0">
        ...
        {error && <div className="px-4 py-2 text-red-600 text-sm bg-red-50 mx-4 rounded">{error}</div>}
        ...
        <div className="flex justify-end gap-2 px-6 pb-4">
          ...
          {wordAction && (
            <Button onClick={handleDownloadWord} variant="outline" className="flex items-center gap-2">
