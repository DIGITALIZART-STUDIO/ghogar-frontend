                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-xl font-bold">Pipeline de Leads</CardTitle>
                                            ...
                                            <div className="flex items-start justify-between gap-4">
                                                <div className="flex items-start gap-4 flex-1">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center gap-3 mb-4">
                                                            ...
                                                            <Badge className={`text-sm font-medium px-3 py-1 ${LeadStatusLabels[lead.status as keyof typeof LeadStatusLabels]?.className ?? "bg-slate-500 text-white"}`}>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                                                            <div className="flex items-center gap-2 p-2 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                                                                ...
                                                                <div>
                                                                    <p className="text-xs font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wide">Teléfono</p>
                                                                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{lead.clientPhone}</span>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-2 p-2 rounded-lg bg-green-50 dark:bg-green-900/20">
                                                                ...
                                                                <div>
                                                                    <p className="text-xs font-medium text-green-600 dark:text-green-400 uppercase tracking-wide">Email</p>
                                                                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{lead.clientEmail ?? "No disponible"}</span>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-2 p-2 rounded-lg bg-amber-50 dark:bg-amber-900/20">
                                                                ...
                                                                <div>
                                                                    <p className="text-xs font-medium text-amber-600 dark:text-amber-400 uppercase tracking-wide">Proyecto</p>
                                                                    <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{lead.projectName}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center gap-4 text-sm">
                                                            ...
                                                            >
                                                                {LeadCaptureSourceLabels[lead.captureSource as keyof typeof LeadCaptureSourceLabels]?.label ?? lead.captureSource}
                                                            </Badge>
                                                            {lead.lastContact && (
                                                ...
                                                <div className="flex items-center gap-6">
                                                    <div className="text-right">
                                                        ...
                                                        <Badge
                                                            variant="outline"
                                                            className={cn("text-sm font-medium px-3 py-1", getPriorityBadge(lead.daysUntilExpiration ?? null))}
                                                        >
                        ...
                        <Card>
                            <CardHeader className="pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl font-bold">Distribución de Fuentes</CardTitle>
                        ...
                        <Card>
                            <CardHeader className="pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl font-bold">Evolución Mensual</CardTitle>
