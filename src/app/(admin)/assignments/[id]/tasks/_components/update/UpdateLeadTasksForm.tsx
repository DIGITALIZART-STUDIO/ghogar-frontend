    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 px-4 sm:px-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="type">Tipo de Tarea</FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="scheduledDate">Fecha Programada</FormLabel>
              <FormControl>
                <DatePicker
        ...
        {form.watch("completedDate") && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="completedDate">Fecha de Completado</FormLabel>
                <FormControl>
                  <DatePicker
                    value={field.value ? parseISO(field.value) : undefined}
                    withTime
