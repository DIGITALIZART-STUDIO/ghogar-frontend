...
import { BlockSearch } from "../../../../_components/search/BlockSearch";
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 px-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel required icon={Tag}>
                    Número de Lote
                  </FormLabel>
                  <FormControl>
                    <Input placeholder="Ingrese el número de lote" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Solo se muestran manzanas activas</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="number"
                      placeholder="Ingrese el precio total del lote"
                      {...field}
                      onChange={(e) => field.onChange(Number.parseFloat(e.target.value) ?? 0)}
                    />
                  </FormControl>
        ...
        <div className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel required>Estado del Lote</FormLabel>
                <Select onValueChange={field.onChange} defaultValue={field.value ?? LotStatus.Available}>
                  <FormControl>
                    <SelectTrigger className=" w-full">
                      <SelectValue placeholder="Seleccione el estado del lote" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
