...
import { AlertCircle, AlertTriangle, Calendar, CheckCircle, Clock, DollarSign, TrendingUp } from "lucide-react";
    ...
    <div className="rounded-lg bg-card overflow-hidden">
      <div className="px-4 py-5 sm:p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-xl leading-6 font-semibold text-gray-900 dark:text-gray-100">Cronograma de Pagos</h3>
            ...
            <tbody className="bg-card divide-y divide-gray-200 dark:divide-gray-600">
              {data.map((payment, index) => {
                ...
                return (
                  <tr
                    key={payment.id}
                    className="hover:bg-zinc-50 dark:hover:bg-zinc-600 transition-colors duration-150"
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Cuota {index + 1}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-lg font-bold text-blue-700 dark:text-blue-400">
                {data.filter((p) => (p.amountPaid ?? 0) > 0 && !p.paid).length}
              </p>
            </div>
