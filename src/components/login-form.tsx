  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <form className="p-6 md:p-8 flex flex-col h-full justify-center" onSubmit={form.handleSubmit(login)}>
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center mb-4">
                  ...
                  <h1 className="text-2xl font-bold">Bienvenido al CRM</h1>
                  <p className="text-muted-foreground text-balance mt-2">Accede a tu portal de gestión inmobiliaria</p>
                </div>
      ...
      <div className="text-center text-sm text-muted-foreground">
        <p>©{new Date().getFullYear()} Gestión Hogar Inmobiliaria. Todos los derechos reservados.</p>
      </div>
    </div>
  );
}
