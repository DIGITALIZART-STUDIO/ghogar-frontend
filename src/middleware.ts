...
function parseSetCookie(cookieString: string) {
    ...
    return {
        ...
        options: {
            ...
            maxAge: cookieMap.has("max-age") ? parseInt(cookieMap.get("max-age") as string, 10) : undefined,
...
export const config = {
    matcher: ["/((?!api|_next|_static|_vercel|favicon.ico|sitemap.xml|portada.webp).*)"],
};
