  ...
  return (
    <TabsContent value="quotations" className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-200">Mis Cotizaciones</CardTitle>
                <CardDescription>Tus cotizaciones generadas y su estado actual</CardDescription>
              </div>
            </div>
            <Button
        ...
        <CardContent>
          {!hasQuotations ? (
            <EmptyState icon={FileText} title="Sin cotizaciones" description="No has generado cotizaciones aún" />
          ) : (
              ...
              {data?.myQuotations?.map((quotation) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-800 dark:text-slate-100">{quotation.code}</h4>
