...
export function ToggleValidationStatusDialog({
    ...
    return (
        <ConfirmationDialog
            ...
            description={
                <>
                    Esta acción cambiará el estado de validación del contrato para la reserva <span className="font-medium">{reservation.quotationCode ?? reservation.id}</span> a <span className="font-semibold">{nextStatusText}</span>.
                </>
            }
